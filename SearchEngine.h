...
public:
	...
	virtual ~CSearchEngine();
	  ...
	  void  virtual SearchAGoodMove(BYTE position[10][9])=0;
	
	  void  virtual SetSearchDepth(int nDepth){m_nSearchDepth = nDepth;};
	
 void  	virtual SetEveluator(CEveluation *pEval){m_pEval = pEval;};

 void 	virtual SetMoveGenerator(CMoveGenerator *pMG){m_pMG = pMG;};
